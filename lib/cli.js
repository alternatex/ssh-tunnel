...
var actions = { 'connect': 'Connect', 'show': 'Show', 'update': 'Update', 'copy': 'Copy', 'delete': 'Delete', 'install': 'Install', 'new': 'New connection' };
  ...
  inquirer.prompt([
    ...
    switch(answers.action){
      ...
      case actions['show']:
        ...
        //show(selection.connection);
        promptActionSelect(selection.connection);
        break;
      case actions['update']:
